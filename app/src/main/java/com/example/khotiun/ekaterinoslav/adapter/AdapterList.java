package com.example.khotiun.ekaterinoslav.adapter;
...
import com.example.khotiun.ekaterinoslav.utils.MySingleton;
 ...
 */
//класс который получает данные от volley и формирует список с картинками заголовками и другой информацией
public class AdapterList extends UltimateViewAdapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (!isFirstOnly || position > lastPosition) {
            // анимация добавления новых элементов в списке, при прокрутке они добавляются с боку
