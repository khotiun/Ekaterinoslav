...
public class Utils {
    public static final String API_YOUTUBE  = "https://www.googleapis.com/youtube/v3/";//базовый url адрес

    public static final String FUNCTION_SEARCH_YOUTUBE  = "search?";//функция поиск
    public static final String FUNCTION_VIDEO_YOUTUBE   = "videos?";//функция получения видео
    public static final String FUNCTION_PLAYLIST_ITEMS_YOUTUBE   = "playlistItems?";//функция получения плейлиста
    //параметры youtube api для запросов
    ...
    public static final Integer ARG_TIMEOUT_MS  = 4000;//значение таймаута запроса
